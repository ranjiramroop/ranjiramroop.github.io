...
function getElectronPath() {
  ...
  if (electron == null) {
    ...
    try {
      ...
      throw new Error('Couldnt find the path to the electron executable automatically, ' + 'try installing the `electron` or `electron-prebuilt` package, ' + 'or set the `pathToElectron` option to specify the path manually');
    }
  }
